...
you will also find a raw tcp socket server implmented in the backend, if you do not want to spin up the web server.

if you want to play around, you can just clone the repo and from there you have 3 options:
1) fire up the socket server by running main.py, and then open up a powershell and netcat into localhost:4321 (I like netcat, but use whatever you like). this is for you cli lovers.

2) fire up the web server by running WordleHttpJsonAPI.py, and then go to your favorite web browser and type in localhost:8000. this is for you gui lovers.
